...
def augment_brightness(image):
    """
    :param image:
        Source image on which the random brighten will be applied
    :return:
        The image generated by applying random brighten on the source image
    """
...
def augment_flip(image, steer):
    ...
    :param image:
        Source image on which the random brighten will be applied
    :param steer:
        The steering angle associating with source image
    :return:
        The image generated by applying random brighten on the source image
    """
...
###################################################
## preprocessing and generator helper functions ##
##################################################
def preprocess_image_file_train(line_data):
    """
    :param line_data:
        The row index of sample data
    :return:
        The image randomly choosed from left, right and center after being cropped and resized to 64x64xc
        The steering angle associating with the returned image
    """
...
def generator(samples, batch_size=32):
    ...
    :param smaples:
        The training sample data, list
    :param batch_size:
        The hyper parameter batch size
    """
    shuffle(samples)
    while 1:
        images = []
